...
namespace WpfBrowserShell.Interop
{
    ...
    internal static class WindowsInterop
    {
        ...
        internal static void Hook()
        {
            ...
            {
                // Visual Studio doesn't approve of the use of the Obsolete 
                // 'GetCurrentThreadId()' function.  However we must have the
                // physical thread ID for this interop call, so the warning is
                // disabled here.  Should always work as long as we aren't using
                // fibres.
